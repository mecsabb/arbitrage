  ...
  return (
    <div className='page'>
      ...
      <div className='description'>
        ...
        this graph instance as input. <br></br><br></br><b>Note 1:</b> The model response and path-showing animation has been significantly slowed down to allow 
        ...
        <br></br><b>Note 2:</b> Not every path generated by the model will result in profitable arbitrage. However, due to the high speeds of our model, 
